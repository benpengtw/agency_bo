...
export interface AGENCYAJAX_ChildAgencyCommissionReportSum {
  ...
  childAgencyCommissionAmount?: number /* 二級代理佣金 */
  childAgencyExtraBonusAmount?: number /* 二級代理尊享福利 */
  childAgencyCommissionTotalAmount?: number /* 小計 二級代理佣金+二級代理尊享福利 */
}

export interface AGENCYAJAX_ChildAgencyExtraBonusList {
  list?: Array<AGENCYAJAX_ChildAgencyExtraBonusListData> /* 二級代理尊享福利 */
}

export interface AGENCYAJAX_ChildAgencyExtraBonusListData {
  account?: string /* 二級代理帳號 */
  condition?: string /* 達成條件 */
  date?: string /* 達成月份 */
  extraBonus?: number /* 尊享福利 */
}

export interface AGENCYAJAX_CommissionReportResponseData {
  date?: string /* 日期 */
  activeMemberCount?: number /* 活躍數 */
  totalAmount?: number /* 平台輸贏 */
  chargeAmount?: number /* 平台費 */
  depositWithdrawFeeAmount?: number /* 存提手續費 */
  bonusAmount?: number /* 紅利 */
  netProfitAmount?: number /* 淨輸贏/淨營利 */
  type?: number /* 佣金分成類型 [1:一般,2:固定分成] */
  rank?: number /* 佣金等級 */
  commissionPercent?: number /* 佣金百分比 */
  commissionBalanceAmount?: number /* 佣金結餘 */
  commissionAmount?: number /* 佣金 */
  childAgencyCommissionTotalAmount?: number /* 二級代理福利 */
}
...
export interface BACKENDAJAX_DepositResponseData {
  ...
  amount?: number /* 存單金額 */
  fee?: number /* 手續費 */
  status?: number /* 狀態 1:處理中 2:失敗 3:完成 */
...
export interface BACKENDAJAX_GetDepositRequest {
  ...
  status?: number /* 狀態：全部:0 處理中:1 失敗:2 完成:3 */
...
export interface BACKENDAJAX_PromotionDropdownResponse {
  ...
  promotionLaunchedType?: Array<BACKENDAJAX_KeyValue> /* 優惠類型下拉清單 */
...
export interface BACKENDAJAX_GetChannelDayReconciliationRequest {
  ...
  balanceDiff?: boolean /* 是否有差額 */
  balanceChange?: boolean /* 是否有異動 */
}
...
export interface GAMEAJAX_UpdateGameListRequest {
  ...
  status?: number /* 遊戲狀態 [1:關閉,2:正常] */
  sort?: number /* 排序 */
  imageH5File?: File | Blob /* 遊戲圖片(H5) */
  imagePcFile?: File | Blob /* 遊戲圖片(PC) */
}
...
export interface MEMBERAJAX_LoginResponse {
  ...
  forceTwoPhase?: number /* 進入二階段認證 1:進入  2:不用 */
}
...
export interface PAYMENTAJAX_PromotionListRequest {
  type?: number /* 優惠分類(API:backend/promotion/dropdown->promotionLaunchedType) */
}
...
export interface SwaggerApi{
   ...
   * @summary 二級代理尊享福利列表
   */
  get(url: "/agency/agency/childagencyextrabonuslist", options?: {} & IDefaultOptions): Promise<AGENCYAJAX_ChildAgencyExtraBonusList>
