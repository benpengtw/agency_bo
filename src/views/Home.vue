  ...
  >
    <div class="growshrink pt-8 mb-2 text-center h-[200px] homeHaeader">
      <div class="CENTER_C">
        ...
        <div class="text-primary">{{ $t("home_1") }}</div>
    ...
    <div class="container pl-4 pr-4 growshrink FLEX_C">
      <div class="grow">
        <h5 class="text-primary">◆ {{ $t("home_5") }}</h5>
      </div>
        ...
        <router-link to="newRegistrationList">
          <div class="flex justify-between py-2">
            <div class="flex items-center ml-4 text-primary">
              <span
                class="
                  text-primaryLight text-[1.5rem]
                  my-icon my-icon-register
                  mr-2
                "
              ></span>
              <span class="text-xs text-primary">{{ $t("home_6") }}</span>
            </div>
          ...
          <div class="flex justify-between py-2">
            <div class="flex items-center ml-4 text-primary">
              <span
                class="
                  text-primaryLight text-[1.5rem]
                  my-icon my-icon-money
                  mr-2
                "
              ></span>
              <span class="text-xs text-primary">{{ $t("home_7") }}</span>
            </div>
            <div class="flex items-center">
              {{ state.todayBetting }}
              <van-icon class="text-subWhite" name="arrow" />
          ...
          <div class="flex justify-between py-2">
            <div class="flex items-center ml-4 text-primary">
              <span
                ...
                "
              ></span>
              <span class="text-xs text-primary">{{ $t("home_8") }}</span>
            </div>
            <div class="flex items-center">
              {{ state.walletBalance }}
              <van-icon class="text-subWhite" name="arrow" />
    ...
    <div class="grid grid-cols-3 gap-4 p-4 growshrink">
      <router-link to="linkPage">
        ...
        >
          ...
          ></p>
          <p class="text-xs text-primary">{{ $t("home_9") }}</p>
        </div>
      </router-link>
      <router-link to="subProxyPage">
        ...
        >
          <p
            class="
              text-[1.5rem] text-primaryLight
              my-icon my-icon-organization my-2
            "
          ></p>
          <p class="text-xs text-primary">{{ $t("home_10") }}</p>
        </div>
      </router-link>
      <router-link to="promotionPage">
        ...
        >
          <p
            class="
              text-[1.5rem] text-primaryLight
              my-icon my-icon-calendar my-2
            "
          ></p>
          <p class="text-xs text-primary">{{ $t("home_11") }}</p>
        </div>
      </router-link>
    </div>
  </div>
...
import { getUser } from "@/api/member/authorize";
